...
List data type
--------------
-->List is a collectio of different data types and it is represent by [] seprated by comma'''


any = [1,"aareefa",[2,"this is 5th class",3],56]
print(any[2][1][10])
...
->Tthis will work based on index position
